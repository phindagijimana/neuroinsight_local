        ...
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div className="space-y-6">
            <h2 className="text-5xl font-bold text-gray-900 leading-tight">
              ...
              <span className="text-[#003d7a]"> Volumetric Analysis</span>
            </h2>
              ...
              <svg viewBox="0 0 400 400" className="w-full h-auto">
                <defs>
                  <linearGradient id="brainGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#003d7a" stopOpacity="0.8" />
                    <stop offset="100%" stopColor="#003d7a" stopOpacity="0.6" />
                  </linearGradient>
                </defs>

                <ellipse cx="200" cy="200" rx="150" ry="170" fill="#eff6ff" stroke="#003d7a" strokeWidth="3"/>
                <line x1="200" y1="30" x2="200" y2="370" stroke="#003d7a" strokeWidth="2" strokeDasharray="5,5" opacity="0.3"/>

                <path d="M 80 150 Q 100 100, 150 120 T 180 160" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>
                <path d="M 70 200 Q 90 180, 130 190 T 170 210" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>
                <path d="M 85 250 Q 110 230, 150 245 T 180 270" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>

                <path d="M 320 150 Q 300 100, 250 120 T 220 160" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>
                <path d="M 330 200 Q 310 180, 270 190 T 230 210" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>
                <path d="M 315 250 Q 290 230, 250 245 T 220 270" fill="none" stroke="#003d7a" strokeWidth="2" opacity="0.7"/>

                <ellipse cx="140" cy="260" rx="25" ry="50" fill="url(#brainGradient)" opacity="0.8">
                  <animate attributeName="opacity" values="0.6;0.9;0.6" dur="3s" repeatCount="indefinite" />
                </ellipse>
                <text x="140" y="335" fill="#003d7a" fontSize="16" fontWeight="bold" textAnchor="middle">L</text>
                ...
                <text x="260" y="335" fill="#003d7a" fontSize="16" fontWeight="bold" textAnchor="middle">R</text>

                <circle cx="140" cy="260" r="55" fill="none" stroke="#003d7a" strokeWidth="2" strokeDasharray="3,3" opacity="0.5"/>
                <circle cx="260" cy="260" r="55" fill="none" stroke="#003d7a" strokeWidth="2" strokeDasharray="3,3" opacity="0.5"/>
              </svg>
