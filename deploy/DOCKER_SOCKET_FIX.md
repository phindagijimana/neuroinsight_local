...
- [OK] **Linux (any distribution)** - Auto-detects GID
- [OK] **WSL2** - Auto-detects Docker Desktop's GID
- [OK] **Docker Desktop** - Works out of the box
- [OK] **Existing containers** - No manual configuration needed
...
- [OK] Ubuntu 20.04, 22.04, 24.04 (native)
- [OK] Debian 11, 12
- [OK] WSL2 (Ubuntu on Windows 10/11)
- [OK] Docker Desktop for Windows
- [OK] Docker Desktop for Mac (via Lima VM)
